<template>
    <div>
        <el-row :gutter="10">
            <el-col :span="6">
                <el-card>
                    <Detail title="总销售额" count="￥ 126242">
                    <template slot="charts">
                        ...
                        &nbsp;&nbsp;
                        <span>日同比&nbsp;&nbsp;19.96% &nbsp;<svg t="1637478988225" class="icon" viewBox="0 0 1024 1024"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4331" width="16" height="16">
                                <path
